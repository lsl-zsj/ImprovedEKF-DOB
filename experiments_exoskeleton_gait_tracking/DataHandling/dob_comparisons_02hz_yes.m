function dob_comparisons_02hz_yes()
...
dob{1}=load('20hznodob');     % 1 nodob
dob{2}=load('20hzmkekf_1');   % 2 mkcekf
dob{3}=load('20hzimm_1');     % 3 immkf
dob{4}=load('20hzckf_1');     % 4 cekf
dob{5}=load('20hzekf_1');     % 5 ekf
dob{6}=load('20hzdob_8');     % 6 ndob
