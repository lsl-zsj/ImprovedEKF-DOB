function dob_comparisons_05hz_yes()
...
dob{1}=load('50hznodob');     % 1 nodob
dob{2}=load('50hzmkekf_1');   % 2 mkcekf
dob{3}=load('50hzimm_1');     % 3 immkf
dob{4}=load('50hzckf_1');     % 4 cekf
dob{5}=load('50hzekf_1');     % 5 ekf
dob{6}=load('50hzdob_8');     % 6 ndob
