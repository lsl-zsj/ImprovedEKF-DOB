function dob_comparisons_01hz_yes()
...
dob{4}=load('10hzckf_1');     % 4 cekf
dob{5}=load('10hzekf_1');     % 5 ekf
dob{6}=load('10hzdob_8');     % 6 ndob
...
set(gca,'fontsize',16)
lg=legend('RDOB','MKCEKF','IMMEKF','MCEKF','EKF','NDOB','Interpreter','latex','NumColumns',3);
...
plot(t,dobd{6}.qe(:,1),'LineWidth',1,'Color',[0.9290 0.6940 0.1250]);
set(gca,'fontsize',16)
legend('MKCEKF','IMMEKF','MCEKF','EKF','NDOB','Interpreter','latex','NumColumns',5)
xticks([])
ylabel('rad','Interpreter','latex')
x2=subplot(2,1,2);
box on
