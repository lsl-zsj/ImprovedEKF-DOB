function dob_comparisons_06hz_yes()
...
dob{1}=load('60hznodob');     % 1 nodob
dob{2}=load('60hzmkekf_1');   % 2 mkcekf
dob{3}=load('60hzimm_1');     % 3 immkf
dob{4}=load('60hzckf_1');     % 4 cekf
dob{5}=load('60hzekf_1');     % 5 ekf
dob{6}=load('60hzdob_8');     % 6 ndob
